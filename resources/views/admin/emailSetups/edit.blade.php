...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.emailSetup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.email-setups.update", [$emailSetup->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('provider_name') ? 'is-invalid' : '' }}" name="provider_name" id="provider_name" required>
                    ...
                    @foreach(App\Models\EmailSetup::PROVIDER_NAME_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('provider_name', $emailSetup->provider_name) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_name') ? 'is-invalid' : '' }}" type="text" name="from_name" id="from_name" value="{{ old('from_name', $emailSetup->from_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_email') ? 'is-invalid' : '' }}" type="text" name="from_email" id="from_email" value="{{ old('from_email', $emailSetup->from_email) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('host') ? 'is-invalid' : '' }}" type="text" name="host" id="host" value="{{ old('host', $emailSetup->host) }}">
                @if($errors->has('host'))
                    <div class="invalid-feedback">
                        {{ $errors->first('host') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('port') ? 'is-invalid' : '' }}" type="text" name="port" id="port" value="{{ old('port', $emailSetup->port) }}">
                @if($errors->has('port'))
                    <div class="invalid-feedback">
                        {{ $errors->first('port') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text" name="username" id="username" value="{{ old('username', $emailSetup->username) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', $emailSetup->password) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('encryption') ? 'is-invalid' : '' }}" type="text" name="encryption" id="encryption" value="{{ old('encryption', $emailSetup->encryption) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip_address') ? 'is-invalid' : '' }}" type="text" name="ip_address" id="ip_address" value="{{ old('ip_address', $emailSetup->ip_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $emailSetup->status) }}">
