...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.whatsAppTemplate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.whats-app-templates.update", [$whatsAppTemplate->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="template_name">{{ trans('cruds.whatsAppTemplate.fields.template_name') }}</label>
                <input class="form-control {{ $errors->has('template_name') ? 'is-invalid' : '' }}" type="text" name="template_name" id="template_name" value="{{ old('template_name', $whatsAppTemplate->template_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject') ? 'is-invalid' : '' }}" type="text" name="subject" id="subject" value="{{ old('subject', $whatsAppTemplate->subject) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('body') ? 'is-invalid' : '' }}" name="body" id="body">{!! old('body', $whatsAppTemplate->body) !!}</textarea>
                @if($errors->has('body'))
                    <div class="invalid-feedback">
                        {{ $errors->first('body') }}
                    </div>
